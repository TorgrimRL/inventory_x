...
- Remote dump syncs to Backblaze B2 `s3://inventoryx-backup/`. 90-day retention.
...
```bash
aws s3 ls s3://inventoryx-backup/ --endpoint-url https://[BUCKET_ENDPOINT]/
aws s3 cp s3://inventoryx-backup/[FILE] /home/inventory/backups/ --endpoint-url https://[BUCKET_ENDPOINT]/
```
