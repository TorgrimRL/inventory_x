...
| Start | Stop | Continue |
| :--- | :--- | :--- |
| **T:** Prioritize the report | **T:** Doing large features | **C, D, K, L, A, T:** Continue as we have done so far |
| | | **D:** Great effort |
...
- **Resolution:** A strict feature freeze deadline is set. All features must be fully ready for review two weeks from today. Additionally, Pull Requests must be opened and ready for review 3 days prior to that deadline (the Friday before the deadline week).
- **Action Item:** **T** to manage and follow up on which tasks/features will be prioritized during Sprint 5.
